...
class _DiagnoseScreenState extends State<DiagnoseScreen> {
  ...
  Future<void> _handleCapture() async {
    ...
    // AddPlantScreen's plant-limit pre-check. hasEnoughFor(kDiagnoseActionCost)
    // rather than a plain atLimit check so this still does the right
    // thing if diagnose's cost is ever weighted differently again (it's
    // 1, same as identify/calculator, as of the cost/market pass that
    // evened all three out — see plans.py's DIAGNOSE_ACTION_COST).
